...
Name:		{{ pypi_package_name }}-{{ conda_dist_flavour }}
Version:	{{ pypi_package_version }}
Release:	0
Summary:	{{ pypi_package_name }} via {{ conda_dist_flavour }} generated by snakepit (EXPERIMENTAL)
...
%description
{{ pypi_package_name }} via {{ conda_dist_flavour }} generated by snakepit (EXPERIMENTAL)
...
wget -nv http://repo.continuum.io/{{ conda_dist_flavour }}/{{ conda_dist_flavour_urlprefix }}-{{ conda_dist_version }}-Linux-x86_64.sh
bash {{ conda_dist_flavour_urlprefix }}-{{ conda_dist_version }}-Linux-x86_64.sh -b -p /opt/{{ pypi_package_name }}
# bootstrap pip
